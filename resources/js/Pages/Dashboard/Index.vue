<template>
  <div>
    ...
    <p class="mb-8 leading-normal">Hey there! Welcome to LaraVue CMS, a demo app designed to help illustrate how <a class="text-indigo-500 underline hover:text-orange-600" href="https://inertiajs.com">Inertia.js</a> works.</p>
    <div class="mb-8 flex">
